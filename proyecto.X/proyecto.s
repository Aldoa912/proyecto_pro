...
VERIFICACION:    
    ...
    CLRF CONT20MS	; LIMPIAMOS EL CONT20MS
...
VERIFICACION2:
    ...
    GOTO DISPLAY	; VAMOS A DISPLAY
DISPLAY:
    INCF NH, F	; INCREMENTAMOS 1 EL CONTADOR2
    MOVF NH, W	; MOVEMOS LO QUE ESTE EN CONTADOR2 A W
    PAGESEL TABLA
    CALL TABLA		; LLAMAMOS A LA TABLA
    MOVWF PORTC		; MOVEMOS LOS DATOS DE W AL PORTD
...
VERIFICACION3:
    ...
    GOTO VERIFICACION	; VAMOS A VRIFICACION
    CLRF NH	; LIMPIAMOS LA VARIABLE DE CONTADOR2
    GOTO VERIFICACION	; VAMOS A VERIFICACION
